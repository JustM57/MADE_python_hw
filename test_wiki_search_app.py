...
def test_can_proxy_request_to_wiki_get_json_output(client):
    ...
    assert FIRST_PYTHON_DOCUMENT == json_response["documents"][0]
...
def test_can_parse_wiki_search_output():
    ...
    assert FIRST_PYTHON_DOCUMENT == documents[0]